...
/** \mainpage RoboComp::componente2
 *
 * \section intro_sec Introduction
 *
 * The componente2 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/componente2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class componente2 : public RoboComp::Application
{
public:
	componente2 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::componente2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
